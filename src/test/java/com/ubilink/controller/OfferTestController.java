 ...
 * com.ubilink.service.OfferService; import
 ...
 * 
 * @WebAppConfiguration public class OfferTestController {
 * 
 ...
 * }
 * 
 * @Test public void offerListByMallAndCategory() throws Exception {
 * 
 * mockMvc.perform(get(
 * "/requestOffers/listByMallAndCategory?placeId=367&userId=615&pageNum=0&pageSize=10&categoryId=3"
 ...
 * 
 * 
 * @Test public void offerListAll() throws Exception {
 * 
 * mockMvc.perform(get("requestOffers/listAll/?userId=1"))
 * .andExpect(status().isOk())
 * .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8));
 * 
 * } }
